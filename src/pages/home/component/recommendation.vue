<template>
  <div class="custom-navbar-padding-right custom-navbar-padding-left my-5 d-inline-block">
    <div style="width: 100%;">
    ...
    <Transition name="recommendation-title1">
      <div v-show="recommendationTitle1Flag" v-if="arr_car.length > 0" class="testimony-slick" style="margin-top: 3.375rem; ">
        <div class="">
          <VueSlickCarousel v-bind="slick_setting">
            <div v-for="(car, index) in arr_car" :key="index" class="">
